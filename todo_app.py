...
div[data-testid="stDialog"] div[role="dialog"] { border-radius: 12px; max-width: 380px; }
.confirm { color: #5A5A5E; font-size: 0.95rem; margin: 0 0 0.6rem 0; }
...
def confirm_delete(todo_id: str, label: str) -> None:
    st.markdown(f"<p class='confirm'>{label}</p>", unsafe_allow_html=True)
