...
button[kind="tertiary"] { color: #C4C4C6 !important; padding: 0 0.25rem !important; }
...
# ---------- table ----------
WIDTHS = [1.7, 3.4, 1.4, 0.95, 1.35, 0.45]
...
header_row()
if not todos:
    st.markdown("<div class='empty'>Nothing here yet. Add a task below.</div>",
                unsafe_allow_html=True)
