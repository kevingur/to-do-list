...
[class*="st-key-del_"] div[data-testid="stPopover"] > button {
    width: 100% !important; min-height: 2.6rem !important; padding: 0 !important; border: none !important;
    background: transparent !important; color: #9A9A9E !important; font-size: 1.05rem !important;
    justify-content: center; }
[class*="st-key-del_"] div[data-testid="stPopover"] > button:hover { color: #B24A3A !important; }
[class*="st-key-del_"] div[data-testid="stPopover"] > button span[data-testid="stIconMaterial"] { display: none; }
